...
def export(connect):
    with connect:
        ...
        for hero_stats in parced_table:
            sql_command = f"INSERT INTO {parcer.db} (heroname_as_dotaname,picks,wins,winrate,pickrate) VALUES ('{hero_stats['heroname_as_dotaname']}','{hero_stats['picks']}','{hero_stats['wins']}','{hero_stats['winrate']}','{hero_stats['pickrate']}')"
